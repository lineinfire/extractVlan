...
#processing {
                    ...
                    <div class="pageheader">
                        <div class="media">
                            ...
                            <div class="media-body">
                                ...
                                <h4 style="margin-top: 10px;font-size: 14px;">Vlan Map</h4>
                            </div>
                        </div><!-- media -->
                    </div><!-- pageheader -->
    ...
    <form id="changevlan" method="post">
...
?>
      ...
      <div class="form-group col-md-6">
        <input class="form-control" name="portid" id="portid" placeholder="Switch Port Number">
      </div>

       <div class="form-group col-md-6">
        <input class="form-control" name="empname" id="empname" placeholder="Employee Name" type="hidden" disabled="">
      </div>

      <div class="form-group col-md-6">
        <input class="form-control" name="currentvlan" id="currentvlan" 
         type="hidden" disabled="">
      </div>
         <div class="form-group col-md-12">
        <input class="form-control" name="newvlan" id="newvlan" placeholder="Please enter New Vlan">
      </div>
 ...
 <div id="loading" style="display: none;"> </div>
  <div id="processing" style="display: none;"> </div>
        ...
        <script src="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-validator/0.5.3/js/bootstrapValidator.js"></script>
            <script src="../js/onchange.js" type="text/javascript"></script>
        <script src="../js/validate_changevlan.js" type="text/javascript"></script>
    </body>
