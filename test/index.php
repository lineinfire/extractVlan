        ...
        <div class="divs">
          <form id="login-form" method="post">
            <div class="form-group col-md-8">
              <label for="switchid">Switch Location *</label>
              <select placeholder="Switch IP" id="switchid" name="switchid" class="form-control"> <option  selected>Please Select Switch IP</option>
                <option value="192.168.7.229">192.168.7.229</option>
                <?php
            ...
            // echo "</select>";
              ...
              <div class="form-group col-sm-8">
                ...
                <input type="text" id="vlanid" class="form-control" name="vlanid" >
              </div>
              <div class="form-group col-sm-8">
  ...
  <script type="text/javascript">
    ...
    $(document).ready(function() {
      $('#login-form').bootstrapValidator({
        ...
        fields: {
          vlanid: {
            message: 'The vlanid is not valid',
            validators: {
              notEmpty: {
                message: 'The VLAN address is required and can\'t be empty'
              },
              remote: {
                message: 'The vlanid already exists in the switch..',
                url: 'switch.php',
                type: 'POST',
                async: true,
                data: {
                  switchid: function() { return $( "#switchid" ).val();},
                  vlanid: function() { return $( "#vlanid" ).val();}
                  // switchid : "192.168.7.229", vlanid : 23
                },
                dataType: 'JSON',
                success: function(response)
                {
                  ...
                  if (response != 'true')
                    return "This has been already registered";
                  else
                    return true;
                },
          ...
          switchlocation: {
            validators: {
              notEmpty: {
                message: 'The Switch Location is required and can\'t be empty'
              },
            }
          },
          password: {
