...
<head>
  ...
  <link rel="stylesheet" href="style/nova.css">
  <link rel="stylesheet" href="style/calendarview.css">
  <link rel="stylesheet" href="vlanform.css">
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
	...
	<hr />
	 ...
	 <form class="jotform-form" action="https://submit.jotform.me/submit/70413195868463/" method="post" name="form_70413195868463" id="70413195868463" accept-charset="utf-8">
  <input type="hidden" name="formID" value="70413195868463" />
  <div class="form-all">
    <ul class="form-section page-section">
      ...
      <li class="form-line jf-required" data-type="control_dropdown" id="id_4">
        ...
        <div id="cid_4" class="form-input jf-required">
          <select class="form-dropdown validate[required]" id="input_4" name="q4_switchLocation4" style="width:150px;" data-component="dropdown">
            <option value="">  </option>
      ...
      <li class="form-line jf-required" data-type="control_textbox" id="id_5">
        ...
        <div id="cid_5" class="form-input jf-required">
          <input type="text" id="input_5" name="q5_newVlan" data-type="input-textbox" class="form-textbox validate[required]" size="20" value="" data-component="textbox" />
        </div>
      </li>
      <li class="form-line jf-required" data-type="control_textbox" id="id_6">
        ...
        <div id="cid_6" class="form-input jf-required">
          <input type="text" id="input_6" name="q6_ipAddress" data-type="input-textbox" class="form-textbox validate[required]" size="20" value="" data-component="textbox" />
        </div>
      </li>
      <li class="form-line jf-required" data-type="control_textbox" id="id_7">
        ...
        <div id="cid_7" class="form-input jf-required">
          <input type="text" id="input_7" name="q7_subnetMask" data-type="input-textbox" class="form-textbox validate[required]" size="20" value="" data-component="textbox" />
        </div>
      </li>
  ...
  <input type="hidden" id="simple_spc" name="simple_spc" value="70413195868463" />
  <script type="text/javascript">
  document.getElementById("si" + "mple" + "_spc").value = "70413195868463-70413195868463";
  </script>
</form>
...
<script src="https://cdn.jotfor.ms/static/jotform.forms.js?3.3.17440" type="text/javascript"></script>
<script type="text/javascript">
