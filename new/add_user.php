...
.has-error .checkbox, .has-error .checkbox-inline, .has-error .control-label, .has-error .help-block, .has-error .radio, .has-error .radio-inline, .has-error.checkbox label, .has-error.checkbox-inline label, .has-error.radio label, .has-error.radio-inline label {
    ...
    display: block;
					...
					<form id="bghimire" method="post" action="update.php?id=<?php echo $id?>  
    ...
    <div class="input-group-addon">
     <span class="glyphicon glyphicon-cog"></span> 
        ...
        <input class="form-control" name="name" id="name"  class="stacked-input"  placeholder="Please enter Your Name" type="text">
      </div>
	  </div>
	...
	<input class="form-control" name="modulegroupname" id="modulegroupname" class="stacked-input"  laceholder="Please enter the Module Group Name" type="text">
      </div>
	  </div>
     ...
     <span class="glyphicon glyphicon-cog"></span>
        ...
        <input class="form-control" name="modulecode" id="modulecode" class="stacked-input" class="stacked-input" placeholder="Please enter the Module Code" type="text">
      </div>
	  </div>
	 ...
	 <span class="glyphicon glyphicon-user" ></span>
        ...
        <input class="form-control" name="modulename" id="modulename" class="stacked-input" class="stacked-input"  placeholder="Please enter your Module Name" type="text">
      </div>
	  </div>
      ...
      <p style = color:yelow;>Order Group Information *</p>
      <div class="form-group col-md-12">
	   <div class="input-group">
    <div class="input-group-addon">
     <span class="glyphicon glyphicon-user"></span> 
    </div>
       <input class="form-control" name="modulegrouporder" maxlength="3" id="modulegrouporder" class="stacked-input" placeholder="Please enter your Module Group Order " type="text">
     </div>
	 </div>
    ...
    <div class="input-group-addon">
     <span class="glyphicon glyphicon-cog"></span> 
        ...
        <input class="form-control" name="moduleorder" id="moduleorder" placeholder="Please enter your Module Order" class="stacked-input" type="text">
      </div>
	  </div>
    ...
    <div class="input-group-addon">
     <span class="glyphicon glyphicon-cog"></span> 
       ...
       <input type="text" class="form-control" id="modulepagename" name="modulepagename" class="stacked-input" placeholder="Enter your module Page Name" >
     </div>
	 </div>
   ...
   <div class="input-group">
    <div class="input-group-addon">
     <span class="glyphicon glyphicon-cog"></span> 
             ...
             <select class="form-control"  id="status" name="status"> <option class="form-control" class="stacked-input" value="" selected>Role Activation Status</option>
            <option value="enabled">Activate Module</option>
            <option value="disabled">Deactivate Module</option>
</select>
     </div>
   </div>
