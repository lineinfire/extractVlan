	...
	<header class="top-bar">
		...
		<div class="main-brand">
			<div class="main-brand__container">
				...
				<div class="dropdown">
					<button class="btn btn-block violet dropdown-toggle" style="border-color: transparent; outline: none -moz-focus-inner,a::-moz-focus-inner; border:0;" type="button"  id="dropdownMenu2" data-toggle="dropdown">
						<i class="pe-7g-user" >Settings</i>
					</button>
		...
		<aside class="sidebar">
			...
			<div class="user-info">
					<figure class="rounded-image profile__img">
						<img class="media-object" src="php_action/uploads/<?php echo $row['file']; ?>" target="_blank" alt="user">
					</figure>
					<h2 class="user-info__name"><?php echo $row['name']; ?></h2>
